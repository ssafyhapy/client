      ...
      <MainGradientBackground>
        <MyPageFrame>
          <div className="flex flex-col items-center gap-5">
            ...
            <div>
              <div className="w-[820px] h-[200px] bg-[rgba(255,255,255,0.3)] shadow-[0_0_30px_rgba(66,72,81,0.3)] border-[10px] border-[rgba(255,255,255,0.2)] flex p-5 gap-5 relative">
                <Carousel>
                  <h1>애도 캐러셀이다.</h1>
                </Carousel>
              </div>
