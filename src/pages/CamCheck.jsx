...
const CamCheck = () => {
  ...
  return (
    <GameBackground>
      <div className="flex flex-col justify-center items-center p-[2.5rem] w-full relative">
        <div className="w-[90%] relative">
          <div className="bg-white flex flex-col justify-center items-center p-[1rem] rounded-[40px] shadow-[0_0_30px_rgba(66,72,81,0.2)] mb-[20px]">
