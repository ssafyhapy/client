...
const CamCheck = () => {
  ...
  return (
    <GameBackground>
      <div className="flex flex-col justify-center items-center p-[2rem] w-full max-h-[95vh] relative">
        <div className="w-[80%] relative ">
          <div className="bg-white flex flex-col justify-center items-center p-[2rem] rounded-[40px] shadow-[0_0_30px_rgba(66,72,81,0.2)] mb-[20px] max-h-[65vh]">
