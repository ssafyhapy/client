    ...
    <div className="flex">
      ...
      <div className="w-[350px] h-[300px] bg-white rounded-[30px] flex flex-col gap-3 items-center justify-center">
        ...
        <p className="text-black">
          <span className="opacity-20">저희 밸런스 게임은</span> <span className="text-[#4D98F7]">모임과 관련된 주제 혹은</span>
        </p>
        
        <p className="text-black">
          <span className="text-[#4D98F7]">재미있는 주제</span><span className="opacity-20">를 주기도 할 거예요!</span>
        </p>
