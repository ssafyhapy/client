...
// Modal.js
// import React from 'react';
// import BasicBtn from './BasicBtn'; // Adjust the import path based on your project structure

// const Modal = ({ userName, readyPeople, btnText, onClose }) => {
//   return (
//     <div className="fixed inset-0 flex justify-center items-center bg-[rgba(0,0,0,0.5)] z-50">
//       <div className="bg-[rgba(255,255,255,0.95)] w-[50%] h-[30%] flex rounded-2xl shadow-lg">
//         <div className="bg-custom-modal m-10 p-8 justify-center items-center relative rounded-2xl w-full">
//           <div className="p-3 flex items-center">
//             <div className="flex flex-col mr-2">
//               <p className="font-bold text-sm">
...
//               </p>
//               <p className="text-[rgba(220,89,100)] text-xs">
//                 *현재 {readyPeople}명이 김남숙님을 기다리고 있어요!
//               </p>
//             </div>
//             <img
//               src="src/assets/writing_character.png"
